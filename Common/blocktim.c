...
/* Task behaviour. */
#define bktSHORT_WAIT               ( ( ( portTickType ) 20U ) / configTICK_RATE_MS )
#define bktPRIMARY_BLOCK_TIME       ( ( portTickType ) 10U )
#define bktALLOWABLE_MARGIN         ( ( portTickType ) 15U )
#define bktTIME_TO_BLOCK            ( ( portTickType ) 175U )
#define bktDONT_BLOCK               ( ( portTickType ) 0U )
#define bktRUN_INDICATOR            ( 0x55U )
