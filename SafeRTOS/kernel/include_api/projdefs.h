...
#define pdKERNEL_MAJOR_VERSION                      ( 9 )
#define pdKERNEL_MINOR_VERSION                      ( 4 )
#define pdKERNEL_RC_VERSION                         ( 0 )
...
#define errINVALID_ALIGNMENT                        ( ( portBaseType ) -5 )
...
/* Error -32 "errRTS_CALCULATION_ERROR" has been removed */
/* Error -33 "errINVALID_PERCENTAGE_HANDLE" has been removed */
...
#define errEVT_MPLX_OBJECT_ALREADY_IN_USE           ( ( portBaseType ) -58 )
#define errINVALID_EVT_MPLX_HANDLE                  ( ( portBaseType ) -59 )
#define errINVALID_EVT_MPLX_OPERATION               ( ( portBaseType ) -60 )
#define errEVT_MPLX_OBJECT_EVENTS_LIMIT_REACHED     ( ( portBaseType ) -61 )
#define errINVALID_EVT_MPLX_EVENTS                  ( ( portBaseType ) -62 )
#define errEVT_MPLX_NO_EVENTS_OCCURRED              ( ( portBaseType ) -63 )
#define errINVALID_DATA_RANGE                       ( ( portBaseType ) -64 )
#define errNO_TICK_SETUP_HOOK_DEFINED               ( ( portBaseType ) -65 )
/* Error -66 "errSB_ZERO_TRIGGER" has been removed. */
/* Error -67 "errSB_ZERO_BUFFER" has been removed. */
/* Error -68 "errSB_SMALL_BUFFER" has been removed. */
/* Error -69 "errSB_TRIGGER_TOO_HIGH" has been removed. */
#define errSB_IN_USE                                ( ( portBaseType ) -70 )
/* Error -71 "errSB_NULL_HANDLE" has been removed. */
#define errSB_INVALID_HANDLE                        ( ( portBaseType ) -72 )
/* Error -73 "errSB_NULL_BUFFER" has been removed. */
/* Error -74 "errSB_NOTIFICATION_TIMEOUT has been removed. */
/* Error -75 "errSB_INVALID_ISMESSAGEBUFFER_PARAMETER" has been removed. */
#define errSB_CORRUPT_MESSAGE                       ( ( portBaseType ) -76 )
#define errSB_LOCK_UNAVAILABLE                      ( ( portBaseType ) -77 )
#define errSB_CORRUPTED                             ( ( portBaseType ) -78 )
#define errWAITING_TASK_NOT_NOTIFIED                ( ( portBaseType ) -79 )
